            ...
            <div class="col-md-3 col-md-offset-1 col-sm-4 col-xs-12">
                ...
                <ul class="list-category">
                    <?php foreach ($categories as $categorie): ?>
                        <li>
                            <a href=<?php PATH_PUBLIC . '/' . $categorie->getROUTECATEGORIE(); ?>>
                                <?php echo $categorie->getLIBELLECATEGORIE(); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            ...
            <div class="col-md-3 col-md-offset-1 col-sm-4 col-xs-12">
                ...
                <div class="list-tags">
                    <?php foreach ($tags as $tag): ?>
                        <li>
                            <a href=<?php PATH_PUBLIC . '/' . $tag->getLIBELLETAGS(); ?>>
                                <?php echo $tag->getLIBELLETAGS(); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
